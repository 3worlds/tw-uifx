...
* `\*parentTo*: \*component* -> \*component*` may be used to relate a component to its offspring, i.e. it enables to track genealogic links between components (<<configuration-ecosystem-dynamics.adoc#truefunction>>).
