...
`/3worlds/ecosystem/dynamics/lifeCycle/*recruit*:<[underline]##__name__##>` {0..*}
...
`/3worlds/ecosystem/dynamics/lifeCycle/*produce*:<[underline]##__name__##>` {0..*}
...
`/3worlds/ecosystem/dynamics/timeLine/timeModel/*process*:<[underline]##__name__##>` {1..*}
...
`/3worlds/ecosystem/dynamics/timeLine/timeModel/*function*:<[underline]##__name__##>` {1..*}
...
** __ecosystem__-level data, i.e. ecosystem parameters, state variables, population data (= number of system components, of newly created and deleted ones), and name;
...
`/3worlds/ecosystem/dynamics/*initialState*:<__name__>` {0..1}
...
`/3worlds/.../individual/**parameterValues**:<__name__>` {0..*}
...
`/3worlds/.../individual/**variableValues**:<__name__>` {0..*}
