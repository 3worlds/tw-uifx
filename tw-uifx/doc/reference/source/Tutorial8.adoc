...
image::tutorial8IMG/fig-tut8-config.png[align="left",role="thumb", width="1000"]
...
image::tutorial8IMG/fig-tut8-consoleOutput.png[align="left",role="thumb", width="700"]
...
[#fig-tut8-expDirs]
.Directory structure created by the `fstWriter` and `popWriter` widgets.
image::tutorial8IMG/fig-tut8-expDirs.png[align="left",role="thumb", width="400"]
