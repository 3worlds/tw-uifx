...
Now define the _roles_ of the new component types for the community and disturbance. Both are _permanent_, _atomic_, belongs to the _component_ category and accesses data through their respective categories.
