...
image::using-modelmakerIMG/fig-properties-all.png[role="thumb",align="left",float="right"]
...
image::using-modelmakerIMG/fig-properties-selected.png[role="thumb",align="left",float="right"]
...
image::using-modelmakerIMG/fig-msg-actions.png[role="thumb",align="left",float="right"]

... *Details*: This level shows the action message and the specification constraint that is unsatisfied. The information provided varies with the message but in general include <<fig-msg-details>>:
...
image::using-modelmakerIMG/fig-msg-details.png[role="thumb",align="left",float="right"]
...
image::using-modelmakerIMG/fig-msg-debug.png[role="thumb",align="left",float="right"]
