...
image::tutorial3IMG/fig-records-tables.svg[role=left,width=125,height=72]
...
image::tutorial3IMG/fig-description-property-option.png[role=left]
...
image::tutorial3IMG/fig-tree.png[align="center"]

[#fig-links]
.Cross-links of the final specifiation graph for Tutorial 3.
image::tutorial3IMG/fig-links.png[align="center"]
...
image::tutorial3IMG/fig-javaDoc.png[align="center"]
