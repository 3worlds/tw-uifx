...
This tutorial explains the procedure for creating a simulation with _ModelMaker_, using a simple logistic equation as a test case. New capabilities are gradually introduced with each tutorial as we explore the full range of modelling features available. 
