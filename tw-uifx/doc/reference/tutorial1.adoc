...
This tutorial explains the procedure for developing and running a simulation with _ModelMaker_. We start by using a simple logistic equation as a test case and gradually introduce more capabilities over the course of the tutorials as we explore the full range of modelling features available.
