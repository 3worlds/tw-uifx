...
/**
 * Generates a fully crossed (also known as a full factorial) expansion of an
 * array of conditions
 */
public class FullFactorial {
	public static List<List<Integer>> getFactorialIndicies(List<Integer> levels) {
		FullFactorial f = new FullFactorial(levels);
		return f.getFullFactorial();
	}
	...
	/**
	 * Randomize a design matrix and add "centerpoint" runs at the beginning,
	 * middle, and end of the matrix as per NIST recommendations
	...
	public static void main(String[] args) {
		Integer[] levels = { 2, 3 };
		FullFactorial f = new FullFactorial(levels);
		List<List<Integer>> ff = f.getFullFactorial();
