 ...
 */
public class SimpleTimeSeriesWidgetOld extends AbstractDisplayWidget<TimeSeriesData, Metadata> implements Widget {

	private static Logger log = Logging.getLogger(SimpleTimeSeriesWidgetOld.class);
	...
	public SimpleTimeSeriesWidgetOld(StateMachineEngine<StatusWidget> statusSender) {
